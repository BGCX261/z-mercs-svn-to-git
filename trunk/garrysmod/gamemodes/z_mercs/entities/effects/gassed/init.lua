...
--Ground cover
		for i=1,math.ceil(self.Scale*45) do
			...
			local velocity = math.Rand(100,1200)*vecang
			local particle = emitter:Add("particles/smokey",  self.Position - vecang*32*self.Scale - self.Normal*64)
			local dietime = math.Rand(40,45)*self.Scale
			...
			particle:SetRoll(math.Rand(50,75))
